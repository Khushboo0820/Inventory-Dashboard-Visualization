...
import { fetchItrData } from '@/lib/api';

export default function Q4Itr() {
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const response = await fetchItrData({ category, abcClass, itemId, startDate, endDate });
  ...
  return (
    <>
      <Head>
        <title>Q4: Inventory Turnover Ratios</title>
      </Head>
      <div className="container mx-auto p-4">
        <h1 className="text-2xl font-bold mb-4">Inventory Turnover Ratios</h1>
